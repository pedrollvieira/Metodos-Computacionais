...
def main():
    ...
    # Reordenar a lista com cada método e medir o tempo de execução
    tempos = {}
    ...
    print("\n")
    print(f"Tempo de execução do Merge Sort: {tempos['mergesort']:.6f} segundos")
    print(f"Tempo de execução do Quick Sort: {tempos['quicksort']:.6f} segundos")
    print(f"Tempo de execução do Heap Sort: {tempos['heapsort']:.6f} segundos")
